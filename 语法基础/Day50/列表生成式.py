...
list = filter_non_unique([1, 2, 3, 4, 2, 4, 5])
print(list)
...
print(bifurcate_by(['Python3', 'up', 'users', 'pople'], lambda x: x[0] == 'u'))
...
print(difference([1, 1, 2, 3, 4], [1, 2, 6]))
