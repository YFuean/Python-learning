'''
气泡图
Seaborn是一种基于matplotlib地图学可视化python library
它提供了一种高度交互式界面，便于用户能够做出各种有吸引力地统计图表
'''
...
sns.set_style('white')
# Step 1: Prepare Data
midwest = pd.read_csv("./res/csv/midwest_filter1.csv")
...
for i, category in enumerate(categories):
    plt.scatter('area', 'poptotal',
                data=midwest.loc[midwest.category == category], s='dot_size', c=colors[i], label=str(category), edgecolor='black', linewidths=.5)
# Step 3: Encircling
